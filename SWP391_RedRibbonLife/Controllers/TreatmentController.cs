...
namespace SWP391_RedRibbonLife.Controllers
{
    ...
    public class TreatmentController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [Authorize(AuthenticationSchemes = "LoginforLocaluser", Roles = "Admin, Manager, Staff, Doctor, Patient")]
        public async Task<ActionResult<APIResponse>> GetTreatmentByPatientIdAsync(int id)
        {
            var apiResponse = new APIResponse();
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [Authorize(AuthenticationSchemes = "LoginforLocaluser", Roles = "Admin, Manager, Staff, Doctor, Patient")]
        public async Task<ActionResult<APIResponse>> GetTreatmentByTestResultIdAsync(int id)
        {
            var apiResponse = new APIResponse();
            try
            {
                ...
                var treatment = await _treatmentService.GetTreatmentByTestResultIdAsync(id);
                apiResponse.Data = treatment;
                apiResponse.Status = true;
                apiResponse.StatusCode = HttpStatusCode.OK;
                return Ok(apiResponse);
