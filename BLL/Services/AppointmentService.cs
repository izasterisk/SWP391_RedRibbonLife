...
public class AppointmentService : IAppointmentService
{
    ...
    public AppointmentService(IMapper mapper, SWP391_RedRibbonLifeContext dbContext, IRepository<Appointment> appointmentRepository, IRepository<Patient> patientRepository, IRepository<Doctor> doctorRepository, IRepository<DoctorSchedule> doctorScheduleRepository, IUserUtils userUtils, IDoctorScheduleUtils doctorScheduleUtils, SendGridEmailUtil sendGridUtil)
    {
        _mapper = mapper;
