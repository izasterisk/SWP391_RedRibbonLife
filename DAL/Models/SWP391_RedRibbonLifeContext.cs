...
//        => optionsBuilder.UseSqlServer("Server=ADMIN-PC\\SQLEXPRESS;Database=SWP391_RedRibbonLife;Uid=sa;Pwd=12345;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__A50828FCEB3366ED");
        ...
        {
            entity.HasKey(e => e.ArticleId).HasName("PK__Articles__CC36F6606A2B8CAC");
        ...
        {
            entity.HasKey(e => e.RegimenId).HasName("PK__ARVRegim__36DA3D9E9CCCBF77");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__D54EE9B4F723163C");
        });

        modelBuilder.Entity<Doctor>(entity =>
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctors__F39935640E9DCE50");
        ...
        {
            entity.HasKey(e => e.CertificateId).HasName("PK__DoctorCe__E2256D31B78170B1");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__DoctorSc__C46A8A6FFF5E1C83");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__Medicati__C46A8A6FCC3B0F80");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patients__4D5CE476A0957E33");
        ...
        {
            entity.HasKey(e => e.PrescriptionId).HasName("PK__Prescrip__3EE444F8B47153B3");
        ...
        {
            entity.HasKey(e => e.ReminderId).HasName("PK__Reminder__E27A36286297EAA2");
        ...
        {
            entity.HasKey(e => e.TestResultId).HasName("PK__TestResu__152BCEDA7B8B1ED9");
        ...
        {
            entity.HasKey(e => e.TreatmentId).HasName("PK__Treatmen__302D3CA096F40C80");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370F17C86CFA");
